import { AccountPlan } from "../models/account_plan_orm";

const organizations: {account_plan: AccountPlan}[] = [
    {
        account_plan: {
        ...
        account_plan: {
            ...
            confirmationurl: "NULL",
            trialperiodstart: 2023-01-20T00:17:01.000,
...
console.log(`account plan: ${organization.account_plan.planname}`);
}
